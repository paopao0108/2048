...
namespace Assets.Script.View
{
    public class GamePanel : MonoBehaviour
    {
        ...
        {
            GameObject gameObject  = GameObject.Instantiate(gridPrefab, gridParent); // 实例化格子预制体
        ...
        public void CreateNumber()
        {
            ...
            GameObject gameObject = GameObject.Instantiate(numberPrefab, canCreateNumberGrid[gridIndex].transform); // 实例化数字预制体，数字的父节点为格子
